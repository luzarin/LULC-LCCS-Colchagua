...
// ====================== VISUALIZACIÓN ======================
var palette = [
  '#1b9e77', // 1 C1 perenne riego
  '#66a61e', // 2 C2 caducifolio riego
  '#d95f02', // 3 C3 esclerófilo
  '#e6ab02', // 4 C4 matorral/espinal
  '#7570b3', // 5 C5 caducifolio
  '#a6761d', // 6 C6 urbano/suelo
  '#1f78b4'  // 7 C7 agua
];
...
// Título
legend.add(ui.Label({
  value: 'Leyenda — Mapa Clasificado (7 clases)',
  style: {fontWeight: 'bold', fontSize: '14px', margin: '0 0 6px 0'}
}));

// Lista de clases
var classes = [
  {name: 'C1 Agrícola perenne de riego',       color: '#1b9e77'},
  {name: 'C2 Agrícola caducifolio de riego',   color: '#66a61e'},
  {name: 'C3 Bosque esclerófilo',            color: '#d95f02'},
  {name: 'C4 Matorral o espinal',            color: '#e6ab02'},
  {name: 'C5 Bosque caducifolio',            color: '#7570b3'},
  {name: 'C6 Urbano / Suelo desnudo',        color: '#a6761d'},
